...
su - ambari-qa -c "hdfs dfs -rm -r /user/ambari-qa/falcon_demo/hivedb/raw_xml/*"
su - ambari-qa -c "hdfs dfs -rm -r /user/ambari-qa/falcon_demo/hivedb/raw_json/*"
su - ambari-qa -c "hdfs dfs -rm -r /user/ambari-qa/falcon_demo/hivedb/sv_aggregate/*"
su - ambari-qa -c "hdfs dfs -rm -r /user/ambari-qa/falcon_demo/hivedb/sv_json_data/*"
su - ambari-qa -c "hdfs dfs -rm -r /user/ambari-qa/falcon_demo/hivedb/sv_json_data_master/*"
su - ambari-qa -c "hdfs dfs -rm -r /user/ambari-qa/falcon_demo/hivedb/xml_data_archive/*"
