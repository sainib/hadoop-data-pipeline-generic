...
su - hdfs -c "hdfs dfs -mkdir -p /user/ambari-qa/falcon_demo"
su - hdfs -c "hdfs dfs -chmod 777 /user/ambari-qa/falcon_demo"
su - hdfs -c "hdfs dfs -chown ambari-qa:hadoop /user/ambari-qa/falcon_demo"
echo "Create project root directory - Done"

#hql File Directories
echo "Create hql  File  directory - Start"
su - hdfs -c "hdfs dfs -mkdir -p /user/ambari-qa/falcon_demo/hql"
su - hdfs -c "hdfs dfs -chmod 777 /user/ambari-qa/falcon_demo/hql"
su - hdfs -c "hdfs dfs -chown ambari-qa:hadoop /user/ambari-qa/falcon_demo/hql"
su - ambari-qa -c "hdfs dfs -put ${project_root}/hql/* /user/ambari-qa/falcon_demo/hql/"
...
su - hdfs -c "hdfs dfs -mkdir -p /user/ambari-qa/falcon_demo/jars"
su - hdfs -c "hdfs dfs -chmod 777 /user/ambari-qa/falcon_demo/jars"
su - hdfs -c "hdfs dfs -chown ambari-qa:hadoop /user/ambari-qa/falcon_demo/jars"
su - ambari-qa -c "hdfs dfs -put /usr/hdp/${hdp_version}/hive-hcatalog/share/hcatalog/hive-hcatalog-core.jar /user/ambari-qa/falcon_demo/jars/"
su - ambari-qa -c "hdfs dfs -put ${project_root}/udf/target/* /user/ambari-qa/falcon_demo/jars/"
...
su - hdfs -c "hdfs dfs -mkdir -p /user/ambari-qa/falcon_demo/data/input"
su - hdfs -c "hdfs dfs -chmod 777 /user/ambari-qa/falcon_demo/data/input"
su - hdfs -c "hdfs dfs -chown ambari-qa:hadoop /user/ambari-qa/falcon_demo/data/input"
 
su - hdfs -c "hdfs dfs -mkdir -p /user/ambari-qa/falcon_demo/data/process"
su - hdfs -c "hdfs dfs -chmod 777 /user/ambari-qa/falcon_demo/data/process"
su - hdfs -c "hdfs dfs -chown ambari-qa:hadoop /user/ambari-qa/falcon_demo/data/process"

su - hdfs -c "hdfs dfs -mkdir -p /user/ambari-qa/falcon_demo/data/backup"
su - hdfs -c "hdfs dfs -chmod 777 /user/ambari-qa/falcon_demo/data/backup"
su - hdfs -c "hdfs dfs -chown ambari-qa:hadoop /user/ambari-qa/falcon_demo/data/backup"
...
su - hdfs -c "hdfs dfs -mkdir -p /user/ambari-qa/falcon_demo/falcon/workflow"
su - hdfs -c "hdfs dfs -chmod 777 /user/ambari-qa/falcon_demo/falcon/workflow"
su - hdfs -c "hdfs dfs -chown ambari-qa:hadoop /user/ambari-qa/falcon_demo/falcon/workflow"
...
mkdir -p /root/falcon_demo/input
